...
public final class DBQueries {
	...
	public static final String CUSTOMER_SELECT_BYID = "SELECT CUST.CUSTOMER_ID,CUST.NAME,CUST.EMAIL,CUST.REPUTATION,PROD.NAME FROM SPCUSTOMER CUST INNER JOIN SPPRODUCT PROD ON CUST.PRODUCT_ID = PROD.PRODUCT_ID WHERE CUST.CUSTOMER_ID=?";
	
	public static final String CUSTOMER_SELECT_BYPRODUCTID = "SELECT CUST.CUSTOMER_ID,CUST.NAME,CUST.EMAIL,CUST.REPUTATION,PROD.NAME FROM SPCUSTOMER CUST INNER JOIN SPPRODUCT PROD ON CUST.PRODUCT_ID = PROD.PRODUCT_ID WHERE PROD.PRODUCT_ID=?";
