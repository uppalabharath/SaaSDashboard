...
public final class DBQueries {
	...
	public static final String FEATUREREQUEST_INSERT = "INSERT INTO SPFEATUREREQUEST (REQUEST_ID,SUBJECT,DESCRIPTION,IMPACT_FACTOR,CUSTOMER_ID,UPVOTE,ISFREEZED,ROWCREATIONDATE,ROWMODIFIEDDATE) VALUES (SPFEATUREREQUEST_S.NEXTVAL,?,?,?,?,0,0,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP)";
	...
	public static final String FEATUREREQUEST_SELECT_BYCUSTID = "SELECT REQ.REQUEST_ID,REQ.SUBJECT,REQ.DESCRIPTION,REQ.IMPACT_FACTOR,REQ.UPVOTE,"
			+ "REQ.ROWCREATIONDATE,REQ.ISFREEZED,REQ.CUSTOMER_ID,CUST.NAME,PROD.PRODUCT_ID,PROD.NAME,PROD.REPUTATION FROM SPFEATUREREQUEST REQ "
			+ "INNER JOIN SPCUSTOMER CUST ON REQ.CUSTOMER_ID=CUST.CUSTOMER_ID "
			+ "INNER JOIN SPPRODUCT PROD ON PROD.PRODUCT_ID = CUST.PRODUCT_ID "
	...
	public static final String WORKAROUND_INSERT = "INSERT INTO SPWORKAROUND (WORKAROUND_ID,DESCRIPTION,CUSTOMER_ID,REQUEST_ID,UPVOTE,ROWCREATIONDATE,ROWMODIFIEDDATE) VALUES (SPWORKAROUND_S.NEXTVAL,?,?,?,0,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP)";
