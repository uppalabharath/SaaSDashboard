...
public class CustomerDaoImpl implements ICustomerDao {
	...
	@Override
	public long update(Customer customer) throws DaoException {
		LOG.info("In update");
		try {
	...
	@Override
	public List<Customer> getCustomersbyProductId(long productId) throws DaoException {
		LOG.info("In getCustomersbyProductId");
		try {
	...
	public long updateRevenueandReputation(long id, float revenue, float reputation) throws DaoException {
		...
		try{
			return jdbcTemplate.update(DBQueries.CUSTOMER_REV_REPT_UPDATE_BYID, new Object[] {id, revenue, reputation});
		}catch(DataAccessException daEx){
			throw new DaoException(daEx.getMessage(),daEx);
		}
	}
